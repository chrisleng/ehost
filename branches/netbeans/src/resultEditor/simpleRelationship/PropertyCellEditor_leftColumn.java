 ...
 * @author Chris
 */
public class PropertyCellEditor_leftColumn extends AbstractCellEditor implements TableCellEditor {
    ...
    public PropertyCellEditor_leftColumn() {
        super();
    }
    ...
    public Component getTableCellEditorComponent(JTable table, Object value,
            ...
            /*if ( thisrow.type.equals("Markable")){
                ...
                box.addActionListener(new ActionListener(){
                    public void actionPerformed(ActionEvent e) {
                        PropertyCellEditor_leftColumn.this.setCellEditorValue(  box.getSelectedItem().toString() );
                    }
                });
                return box;
            }else{*/
            if (( thisrow.type.equals("new"))||( thisrow.type.equals("attributes"))) {
                // build a jtextfiled as return component for default cell editor
                final JTextField jtextfield;
                if (thisrow.attributeName != null )
                    jtextfield = new JTextField( thisrow.attributeName );
                 else jtextfield = new JTextField( null );

                jtextfield.addActionListener(new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                        PropertyCellEditor_leftColumn.this.setCellEditorValue(  jtextfield.getText() );
                    }
                });
                ...
                jtextfield.addKeyListener(new KeyListener() {
                    ...
                    public void keyTyped(KeyEvent e) {
                        PropertyCellEditor_leftColumn.this.setCellEditorValue(  (jtextfield.getText() + e.getKeyChar()).trim() );
                    }
        ...
        jtextfield2.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                PropertyCellEditor_leftColumn.this.setCellEditorValue(  jtextfield2.getText() );
            }
        });
        ...
        jtextfield2.addKeyListener(new KeyListener() {
            ...
            public void keyTyped(KeyEvent e) {
                PropertyCellEditor_leftColumn.this.setCellEditorValue(  (jtextfield2.getText() + e.getKeyChar()).trim() );
            }
